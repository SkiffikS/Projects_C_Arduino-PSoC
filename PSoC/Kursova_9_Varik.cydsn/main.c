...
#define UART_BUFFER_H_IDX (4)
#define UART_BUFFER_CHANNEL_IDX (5)
#define UART_BUFFER_EQUALS_IDX (6) // EQUALS - Symbol "="
#define UART_BUFFER_D_VALUE_IDX (7)
...
void UartBufferParser(void)
{
 ...
 if ('H' != UartBuffer[UART_BUFFER_H_IDX])
    {
        Error_Return();
        return;
    }
