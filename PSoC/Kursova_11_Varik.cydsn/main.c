...
#define UART_BUFFER_PLUS_IDX (2) // PLUS - Symbol "+"
/* Channel number one */
#define UART_BUFFER_D1_VALUE_IDX (3)
#define UART_BUFFER_H1_VALUE_IDX (4)
#define UART_BUFFER_L1_VALUE_IDX (5)
/* Channel number two */
#define UART_BUFFER_D2_VALUE_IDX (6)
#define UART_BUFFER_H2_VALUE_IDX (7)
#define UART_BUFFER_L2_VALUE_IDX (8)
/* Channel number two */
#define UART_BUFFER_D3_VALUE_IDX (9)
#define UART_BUFFER_H3_VALUE_IDX (10)
#define UART_BUFFER_L3_VALUE_IDX (11)
...
{
        ChannelController(FIRST_CHANNEL);
        ChannelController(SECOND_CHANNEL);
        ChannelController(THIRD_CHANNEL);
}
// ==========================================================================================
...
void Init(void)
{
 ...
 ChannelDescriptorsArray[0].PinControlFunction = BLUE_Write;
 ChannelDescriptorsArray[1].PinControlFunction = GREEN_Write;
 ChannelDescriptorsArray[2].PinControlFunction = RED_Write;
