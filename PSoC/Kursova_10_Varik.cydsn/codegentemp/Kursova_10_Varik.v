// ======================================================================
// Kursova_10_Varik.v generated from TopDesign.cysch
// 11/10/2022 at 21:44
...
module top ;
	...
	wire [0:0] tmpOE__Red_Output_net;
	wire [0:0] tmpFB_0__Red_Output_net;
	wire [0:0] tmpIO_0__Red_Output_net;
	wire [0:0] tmpINTERRUPT_0__Red_Output_net;
	electrical [0:0] tmpSIOVREF__Red_Output_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Red_Output
		 (.oe(tmpOE__Red_Output_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Red_Output_net[0:0]}),
		  .io({tmpIO_0__Red_Output_net[0:0]}),
		  .siovref(tmpSIOVREF__Red_Output_net),
		  .interrupt({tmpINTERRUPT_0__Red_Output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Red_Output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Green_Output_net;
	wire [0:0] tmpFB_0__Green_Output_net;
	wire [0:0] tmpIO_0__Green_Output_net;
	wire [0:0] tmpINTERRUPT_0__Green_Output_net;
	electrical [0:0] tmpSIOVREF__Green_Output_net;

	cy_psoc3_pins_v1_10
		#(.id("de5d70b5-4842-4078-8aef-cc2f9b6bf8ca"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Green_Output
		 (.oe(tmpOE__Green_Output_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Green_Output_net[0:0]}),
		  .io({tmpIO_0__Green_Output_net[0:0]}),
		  .siovref(tmpSIOVREF__Green_Output_net),
		  .interrupt({tmpINTERRUPT_0__Green_Output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Green_Output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Blue_Output_net;
	wire [0:0] tmpFB_0__Blue_Output_net;
	wire [0:0] tmpIO_0__Blue_Output_net;
	wire [0:0] tmpINTERRUPT_0__Blue_Output_net;
	electrical [0:0] tmpSIOVREF__Blue_Output_net;

	cy_psoc3_pins_v1_10
		#(.id("21e3e741-78fd-428c-88a8-9174b31f3d4e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Blue_Output
		 (.oe(tmpOE__Blue_Output_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Blue_Output_net[0:0]}),
		  .io({tmpIO_0__Blue_Output_net[0:0]}),
		  .siovref(tmpSIOVREF__Blue_Output_net),
		  .interrupt({tmpINTERRUPT_0__Blue_Output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Blue_Output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
