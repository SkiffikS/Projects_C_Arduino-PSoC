...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC4, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=1999, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=17, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_Signal_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_Signal_2, CY_INSTANCE_SHORT_NAME=Timer_Signal_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer_Signal_2, )
...
module top ;
    ...
    Timer_v2_80_0 Timer_Signal_1 (
        ...
        .tc(Net_1),
        .trigger(1'b1));
    defparam Timer_Signal_1.CaptureCount = 2;
    defparam Timer_Signal_1.CaptureCounterEnabled = 0;
    defparam Timer_Signal_1.DeviceFamily = "PSoC4";
    defparam Timer_Signal_1.InterruptOnCapture = 0;
    defparam Timer_Signal_1.InterruptOnTC = 0;
    defparam Timer_Signal_1.Resolution = 16;
    defparam Timer_Signal_1.SiliconRevision = "17";
    ...
    Timer_v2_80_3 Timer_Signal_2 (
        ...
        .tc(Net_81),
        .trigger(1'b1));
    defparam Timer_Signal_2.CaptureCount = 2;
    defparam Timer_Signal_2.CaptureCounterEnabled = 0;
    defparam Timer_Signal_2.DeviceFamily = "PSoC4";
    defparam Timer_Signal_2.InterruptOnCapture = 0;
    defparam Timer_Signal_2.InterruptOnTC = 0;
    defparam Timer_Signal_2.Resolution = 16;
    defparam Timer_Signal_2.SiliconRevision = "17";
